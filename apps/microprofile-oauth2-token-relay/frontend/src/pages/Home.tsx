    ...
    return (
        <Container>
            <div className="description-box px-3 py-5 rounded-3">
                <Row>
                    <Col>
                        <h2 className="emphasized-text">Welcome to this Microprofile example!</h2>
                        <p>This example shows how to secure a React frontend and Spring Boot REST API using OAuth2 Token Relay</p>
                    </Col>
                </Row>
                <Row className="mt-5">
                    <Col></Col>
